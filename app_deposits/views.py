...
class DepositTransactionList(LoginRequiredMixin, TokenRequiredMixin, ListView):
    """Class-based view for Deposit Transaction List"""
    model = models.DepositTransaction
    template_name = 'app_deposits/list.html'


class DepositCreate(LoginRequiredMixin, TokenRequiredMixin, CreateView):
...
class DepositView(LoginRequiredMixin, TokenRequiredMixin, FormView):
